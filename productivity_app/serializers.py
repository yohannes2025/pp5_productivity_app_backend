...
class TaskSerializer(serializers.ModelSerializer):
    ...
    category = serializers.PrimaryKeyRelatedField(
        queryset=Category.objects.all())  # Dynamically link to Category model
    priority = serializers.PrimaryKeyRelatedField(
        queryset=Priority.objects.all())  # Dynamically link to Priority model
    status = serializers.PrimaryKeyRelatedField(
        queryset=TaskStatus.objects.all())  # Dynamically link to TaskStatus model
